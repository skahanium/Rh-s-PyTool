...
if __name__ == "__main__":
    print(Addr("四川广元昭化").addr[0, "adcode"])  # type: ignore
    print(Addr("青海海南")._belongs_to())
    print(Addr("青海海南")._coordinate())
    print(lookup("辽宁铁岭"))
    print(belongs_to("玉树", level="city"))
    print(coordinate("常德市", level="city"))
